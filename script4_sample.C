...
//  TFile* inputfile2 = new TFile("/junofs/users/zhangxt/20inch/rec/deconvolution/runs/20200504sample-J20v1r0-Pre0/phy/C14/C14/user_calibCorr.root", "read");
  ...
  TH1F* realDarkrate = (TH1F*)inputfile->Get("darkCharge");
  realDarkrate->Scale(1. / (totalWave * timeinterval));
  ...
  // output as a txt
  ofstream ofile("CalibPars_de.txt");
  for (int i = 0; i < Npmt; i++) {
    // for(int i=0;i<177;i++){
